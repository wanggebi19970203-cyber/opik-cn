...
> = ({ open, onClose }) => {
  ...
  const onSubmit = useCallback(
    (data: FormData) => {
      ...
      submitWizard(submission, {
        onSuccess: () => {
          toast({ description: t("common.welcomeWizard.submitSuccess") });
          onClose();
        },
      });
    },
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle>{t("common.welcomeWizard.title")}</DialogTitle>
          <DialogDescription>
            {t("common.welcomeWizard.description")}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("common.welcomeWizard.yourRole")}</FormLabel>
                  <Select
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel className="font-normal">
                      {t("common.welcomeWizard.joinBetaProgram")}
                    </FormLabel>
                  </div>
                </FormItem>
              )}
            ...
            <div className="space-y-2">
              ...
              >
                {t("common.welcomeWizard.skipAndGoToOpik")}
              </Button>
            </div>
          </form>
        </Form>
