...
const ProjectsSelectBox: React.FC<ProjectsSelectBoxProps> = (props) => {
  ...
  const loadableSelectBoxProps = props.multiselect
    ? {
        options,
        value: props.value,
        placeholder: t("common.automations.selectProjects"),
        onChange: props.onValueChange,
        multiselect: true as const,
        showSelectAll: props.showSelectAll,
        selectAllLabel: props.selectAllLabel || t("common.automations.allProjects"),
      }
    : {
        options,
        value: props.value,
        placeholder: t("common.automations.selectAProject"),
        onChange: props.onValueChange,
  ...
  return (
    <SelectBoxClearWrapper
      ...
      onClear={handleClear}
      disabled={disabled}
      clearTooltip={t("common.automations.clearProjectSelection")}
      buttonSize="icon"
    >
      {selectBox}
    </SelectBoxClearWrapper>
