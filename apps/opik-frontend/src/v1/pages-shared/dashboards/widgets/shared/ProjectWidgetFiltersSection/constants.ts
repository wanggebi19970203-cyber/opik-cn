...
export const TRACE_FILTER_COLUMNS: ColumnData<BaseTraceData>[] = [
  ...
  {
    id: COLUMN_CUSTOM_ID,
    label: i18next.t("dashboards.filters.columns.customFilter"),
    type: COLUMN_TYPE.dictionary,
  },
];
...
export const THREAD_FILTER_COLUMNS: ColumnData<Thread>[] = [
  ...
  {
    id: "first_message",
    label: i18next.t("dashboards.filters.columns.firstMessage"),
    type: COLUMN_TYPE.string,
  },
  {
    id: "last_message",
    label: i18next.t("dashboards.filters.columns.lastMessage"),
    type: COLUMN_TYPE.string,
  },
  {
    id: "number_of_messages",
    label: i18next.t("dashboards.filters.columns.messageCount"),
    type: COLUMN_TYPE.number,
  },
  {
    id: "created_at",
    label: i18next.t("dashboards.filters.columns.createdAt"),
    type: COLUMN_TYPE.time,
  },
  {
    id: "last_updated_at",
    label: i18next.t("dashboards.filters.columns.lastUpdated"),
    type: COLUMN_TYPE.time,
  },
  {
    id: "duration",
