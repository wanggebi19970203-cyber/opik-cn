  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        title={t("experiments:experiments.delete")}
        description={t("experiments:experiments.deleteDescription")}
        confirmText={t("experiments:experiments.delete")}
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="minimal" size="icon" className="-mr-2.5">
            <span className="sr-only">
              {t("experiments:experiments.actionsMenu")}
            </span>
        ...
        <DropdownMenuContent align="end" className="w-52">
          ...
          >
            ...
            {t("experiments:experiments.editAction")}
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem
            onClick={() => {
          ...
          >
            ...
            {t("experiments:experiments.deleteAction")}
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </CellWrapper>
