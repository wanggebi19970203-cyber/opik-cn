  ...
  return (
    <div className="flex size-full flex-col items-center justify-center gap-5 bg-[url('/images/circle-pattern.png')] bg-cover bg-center">
      <img
        ...
        alt={t("errorBoundary.somethingWentWrong")}
        width="274px"
      />

      <h2 className="comet-title-l">{t("errorBoundary.somethingWentWrong")}</h2>
      ...
      <Button onClick={resetError}>{t("errorBoundary.continue")}</Button>
    </div>
  );
};
