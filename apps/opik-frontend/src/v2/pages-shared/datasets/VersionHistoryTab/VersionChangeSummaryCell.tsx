    ...
    >
      {!hasChanges ? (
        ...
        <div className="flex items-center gap-2">
          {itemsAdded > 0 && (
            <TooltipWrapper content={t("versionChangeSummary.itemsAdded")}>
          ...
          {itemsModified > 0 && (
            <TooltipWrapper content={t("versionChangeSummary.itemsModified")}>
          ...
          {itemsDeleted > 0 && (
            <TooltipWrapper content={t("versionChangeSummary.itemsDeleted")}>
