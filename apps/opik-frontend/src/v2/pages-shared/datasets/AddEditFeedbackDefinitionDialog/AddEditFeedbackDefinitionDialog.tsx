  ...
  const typeOptions = [
    {
      ...
      label: t("feedbackDefinition.boolean"),
      description: t("feedbackDefinition.booleanDescription"),
    },
    {
      value: FEEDBACK_DEFINITION_TYPE.categorical,
      label: t("feedbackDefinition.categorical"),
      description: t("feedbackDefinition.categoricalDescription"),
    },
    {
      value: FEEDBACK_DEFINITION_TYPE.numerical,
      label: t("feedbackDefinition.numerical"),
      description: t("feedbackDefinition.numericalDescription"),
    },
  ];

  const [name, setName] = useState<CreateFeedbackDefinition["name"]>(
    mode === "clone" && feedbackDefinition
      ? `${feedbackDefinition.name} (${t("feedbackDefinition.copySuffix")})`
