      ...
      <div className="p-4">
        <div className="flex flex-col items-center justify-center gap-2 py-8">
          ...
          <p className="comet-body-s-accented text-center">
            {t("runEvaluationDialog.noRulesMessage")}
          </p>
          <p className="comet-body-s text-center text-muted-foreground">
            {t("runEvaluationDialog.noRulesDescription")}
          </p>
          <Button
            variant="link"
            size="sm"
            ...
            className="mt-2"
          >
            {t("runEvaluationDialog.createNewRule")}
          </Button>
        </div>
      </div>
    );
    ...
    <>
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="max-w-lg sm:max-w-screen-sm">
          <DialogHeader>
            <DialogTitle>{t("runEvaluationDialog.title")}</DialogTitle>
          </DialogHeader>
          <div className="w-full overflow-hidden">
            <p className="comet-body-s mb-4 text-muted-foreground">
              {t("runEvaluationDialog.description", { entityLabel })}
            </p>
