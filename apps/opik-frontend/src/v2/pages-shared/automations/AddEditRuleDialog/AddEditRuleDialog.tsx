      ...
      formProjectIds.length === 1
        ? [
            <ToastAction
              ...
              size="sm"
              className="px-0"
              altText={t("addEditRule.goToProject")}
              key="Go to project"
              onClick={() => {
                navigate({
  ...
  return (
    <>
              ...
              >
                <FormField
                  ...
                  render={({ field, formState }) => {
                    ...
                    return (
                      <FormItem>
                        <Label>{t("addEditRule.nameLabel")}</Label>
                        <FormControl>
                          <Input
                            className={cn({
                            ...
                            placeholder={t("addEditRule.namePlaceholder")}
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between space-y-0">
                      <div className="flex flex-col">
                        ...
                        >
                          {t("addEditRule.enableRule")}
                        </Label>
                        <Description>
                          {t("addEditRule.enableRuleDescription")}
                        </Description>
                      </div>
                      <FormControl>
                        <Switch
                ...
                {!isEdit && (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <Label>{t("addEditRule.typeLabel")}</Label>
                        <FormControl>
                          <div className="flex">
                            <ToggleGroup
                              type="single"
      ...
      <ConfirmDialog
        ...
        onCancel={cancel}
        onConfirm={confirm}
        title={t("addEditRule.loseChangesTitle")}
        description={t("addEditRule.loseChangesDescription")}
        cancelText={t("addEditRule.cancel")}
        confirmText={t("addEditRule.resetAndContinue")}
      />
    </>
  );
};
