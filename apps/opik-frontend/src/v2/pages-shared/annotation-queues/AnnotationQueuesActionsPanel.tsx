  ...
  return (
    <div className="flex items-center gap-2">
      <ConfirmDialog
        ...
        title={t("annotationQueues.batchDeleteDialog.title")}
        description={t("annotationQueues.batchDeleteDialog.description")}
        confirmText={t("annotationQueues.batchDeleteDialog.confirmText")}
        confirmButtonVariant="destructive"
      />
      <TooltipWrapper content={t("annotationQueues.actions.deleteTooltip")}>
        <Button
          variant="outline"
          size="icon-sm"
          onClick={() => {
