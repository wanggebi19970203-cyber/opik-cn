                    ...
                    if (!option) {
                      return (
                        <span className="text-light-slate">
                          {t("optimizations.configSidebar.selectAlgorithm")}
                        </span>
                      );
                    }
      ...
      <div className="space-y-2">
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="gap-1.5">
              <FormLabel className="comet-body-s-accented">
                {t("optimizations.configSidebar.itemSource")}
              </FormLabel>
              <FormControl>
                <DatasetSelectBox
                  value={field.value}
                  ...
                  placeholder={
                    isPreparingDataset
                      ? t("optimizations.newPage.preparingDataset")
                      : t("optimizations.configSidebar.selectItemSource")
                  }
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                >
                  <a
                    ...
                    rel="noreferrer"
                  >
                    {t("optimizations.configSidebar.goToDocs")}
                ...
                <SelectBox
                  ...
                  renderTrigger={(value) => {
                    ...
                    if (!option) {
                      return (
                        <span className="text-light-slate">
                          {t("optimizations.configSidebar.selectMetric")}
                        </span>
                      );
                    }
                    return renderIconLabel(
