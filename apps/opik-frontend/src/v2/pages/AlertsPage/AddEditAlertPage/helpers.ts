...
export const ALERT_TYPE_LABELS: Record<ALERT_TYPE, string> = {
  [ALERT_TYPE.general]: i18next.t("common.alerts.typeLabels.general"),
  [ALERT_TYPE.slack]: i18next.t("common.alerts.typeLabels.slack"),
  [ALERT_TYPE.pagerduty]: i18next.t("common.alerts.typeLabels.pagerduty"),
};
...
export const TRIGGER_CONFIG: Record<ALERT_EVENT_TYPE, TriggerConfig> = {
  [ALERT_EVENT_TYPE.trace_errors]: {
    title: i18next.t("common.alerts.trigger.traceErrorsTitle"),
    description: i18next.t("common.alerts.trigger.traceErrorsDescription"),
    hasScope: true,
  },
  ...
  [ALERT_EVENT_TYPE.prompt_created]: {
    title: i18next.t("common.alerts.trigger.promptCreatedTitle"),
    description: i18next.t("common.alerts.trigger.promptCreatedDescription"),
    hasScope: false,
  },
  [ALERT_EVENT_TYPE.prompt_committed]: {
    title: i18next.t("common.alerts.trigger.promptCommittedTitle"),
    description: i18next.t("common.alerts.trigger.promptCommittedDescription"),
    hasScope: false,
  },
  [ALERT_EVENT_TYPE.prompt_deleted]: {
    title: i18next.t("common.alerts.trigger.promptDeletedTitle"),
    description: i18next.t("common.alerts.trigger.promptDeletedDescription"),
    hasScope: false,
  },
  ...
  [ALERT_EVENT_TYPE.trace_cost]: {
    title: i18next.t("common.alerts.trigger.costThresholdTitle"),
    description: i18next.t("common.alerts.trigger.costThresholdDescription"),
    hasScope: true,
  },
  [ALERT_EVENT_TYPE.trace_latency]: {
    title: i18next.t("common.alerts.trigger.latencyThresholdTitle"),
    description: i18next.t("common.alerts.trigger.latencyThresholdDescription"),
    hasScope: true,
  },
};
