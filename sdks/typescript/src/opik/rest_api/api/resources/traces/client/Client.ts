...
export class TracesClient {
     ...
     * @param {TracesClient.RequestOptions} requestOptions - 请求特定的配置。
     *
     * @example
    ...
    /**
     * 关闭一个或多个 trace 线程。支持单个 thread_id 和多个 thread_ids 进行批量操作。
     *
    ...
    /**
     * 根据 project_name 或 project_id 获取 trace
     *
    ...
    /**
     * 返回项目是否有至少一条与给定范围匹配的 trace。轻量的存在性探测（LIMIT 1），用于驱动空状态判断，而无需扫描或聚合整个项目。
     *
